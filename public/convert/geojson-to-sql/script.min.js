...
return e.forEach(function(e){t=t+c(e.name)+", "}),t+="wkt"}function s(e){var t="CREATE TABLE temp_from_geojson (\n"
return e.forEach(function(e){t=t+c(e.name)+" "+e.type+",\n"}),t+="wkt text\n);\n"}function a(e){var t=e[0],n=[]
for(k in t.properties){if(isNaN(t.properties[k]))var r="varchar"
else var r="numeric"
n.push({name:k,type:r})}return n}var u=e("wellknown"),c=e("./lib/fix-string"),l=e("../utils/save")
t.exports=function(e,t){var n=a(e.features),i=s(n),o=r(e.features,n),u=i+o
l.text("temp_from_geojson.sql",u),t()}},{"../utils/save":14,"./lib/fix-string":4,wellknown:15}],4:[function(e,t,n){function r(e){return e.replace(" ","_")}function i(e){return e.replace(/[\0\x08\x09\x1a\n\r"'\\\%]/g,function(e){switch(e){case"\x00":return"\\0"
case"\b":return"\\b"
case"	":return"\\t"
case"":return"\\z"
case"\n":return"\\n"
...
e.all_types=c}("undefined"==typeof n?this.GJV={}:n)},{}],14:[function(e,t,n){var r=r||function(e){"use strict"
...
if("function"==typeof i)try{i.call(e,n||e)}catch(o){u(o)}}},m=function(e){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)?new Blob([String.fromCharCode(65279),e],{type:e.type}):e},h=function(t,u,l){l||(t=m(t))
var h,b=this,y=t.type,v=y===c,d=function(){p(b,"writestart progress write writeend".split(" "))},g=function(){if((a||v&&s)&&e.FileReader){var r=new FileReader
...
return t(/^(\))/)?{type:"GeometryCollection",geometries:n}:null}function h(){return a()||l()||f()||u()||c()||p()||m()}var b=e.split(";"),y=b.pop(),v=(b.shift()||"").split("=").pop(),d=0
