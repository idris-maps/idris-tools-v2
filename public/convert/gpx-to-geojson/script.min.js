...
if(i(t))return 1
if(t)return t.length}return 0},r.listenerCount=function(e,t){return e.listenerCount(t)}},{}],2:[function(e,t,n){function r(){i("converter",function(e){o("converter",e,function(){r()})})}var i=e("../../components/drop-zone-gpx/index"),o=e("../../components/convert-gpx/index")
window.onload=function(){r()}},{"../../components/convert-gpx/index":3,"../../components/drop-zone-gpx/index":9}],3:[function(e,t,n){var r=e("./lib/html"),i=e("./lib/ctrl"),o=e("events").EventEmitter
t.exports=function(e,t,n){var s=new o
r.init(e,function(){i(e,t,s)}),s.on("gpx-converted",function(){n()})}},{"./lib/ctrl":6,"./lib/html":7,events:1}],4:[function(e,t,n){function r(){return{type:"Feature",properties:{},geometry:{}}}function i(e,t){var n=e,r=t,i=r-n
i/=1e3
var s=Math.floor(i%60)
i/=60
var a=Math.floor(i%60)
i/=60
var u=Math.floor(i%24),c=Math.floor(i/24)
if(0!==c)var f=c+" d "
else var f=""
return f+o(u)+"h "+o(a)+"m "+o(s)+"s"}function o(e){return 10>e?"0"+e:e}t.exports=function(e,t){var n=r(),o=[],s=0,a=0,u=null,c=null
e.forEach(function(t,n){0===n&&t.time&&(u=t.time),n===e.length-1&&t.time&&(c=t.time),0===n&&t.ele&&(s=t.ele),0!==n&&t.ele&&t.ele>s&&(a+=Math.floor(t.ele-s),s=t.ele),o.push([t.lon,t.lat])}),0!==a&&(n.properties.climb=a),u&&c&&(n.properties.time=i(u,c)),n.geometry={type:"LineString",coordinates:o},t({type:"FeatureCollection",features:[n]})}},{}],5:[function(e,t,n){function r(){return{type:"Feature",properties:{},geometry:{}}}t.exports=function(e,t){var n=[]
e.forEach(function(e,t){var i=r()
e.ele&&(i.properties.ele=e.ele),e.time&&(i.properties.time=e.time),i.geometry={type:"Point",coordinates:[e.lon,e.lat]},n.push(i)}),t({type:"FeatureCollection",features:n})}},{}],6:[function(e,t,n){var r=e("./html"),i=e("./msg"),o=e("./convert-to-points"),s=e("./convert-to-line"),a=e("../../utils/save")
...
u.onclick=function(){r.process(e,function(){i.write("Converting..."),o(t,function(e){i.write("Saving..."),a.json("gpx-points.json",e),n.emit("gpx-converted")})})},c.onclick=function(){r.process(e,function(){i.write("Converting..."),s(t,function(e){i.write("Saving..."),a.json("gpx-line.json",e),n.emit("gpx-converted")})})}}},{"../../utils/save":17,"./convert-to-line":4,"./convert-to-points":5,"./html":7,"./msg":8}],7:[function(e,t,n){n.init=function(e,t){var n=document.getElementById(e)
n.innerHTML='<b>Save as...</b><button id="gpx-to-gj-points">Points</button><button id="gpx-to-gj-line">Line</button><p><b>Points</b> converts to a GeoJSON collection with all the points<br/><br/><b>Line</b> converts to a GeoJSON collection with one "LineString" feature<br/><br/>If you want to show a ride/run on a map, "Line" is what you want.</p>',t()},n.process=function(e,t){var n=document.getElementById(e)
...
t.innerHTML=n+"</br>"+e}},{}],9:[function(e,t,n){var r=e("./lib/html"),i=e("./lib/init"),o=e("./lib/browse"),s=e("events").EventEmitter
t.exports=function(e,t){var n=new s
r.init(e,function(){i(n)
var t=document.getElementById("browse-btn")
t.onclick=function(){r.browse(e,function(){o(n)})}}),n.on("gpx-parsed",function(e){t(e)})}},{"./lib/browse":10,"./lib/html":11,"./lib/init":12,events:1}],10:[function(e,t,n){var r=(e("./msg"),e("./verify-dropped"))
t.exports=function(e){var t=document.getElementById("file-input")
t.onchange=function(n){r(t.files[0],e)}}},{"./msg":13,"./verify-dropped":16}],11:[function(e,t,n){n.init=function(e,t){var n=document.getElementById(e)
...
n.innerHTML='<p id="msg">Load a GPX file</p><input id="file-input" type="file"></input>',t()}},{}],12:[function(e,t,n){function r(e,t){e.preventDefault(),s(e.dataTransfer.files[0],t)}function i(e){e.ondragover=function(e){return e.preventDefault(),!1},e.ondragenter=function(e){return e.preventDefault(),!1}}var o=e("./msg"),s=e("./verify-dropped")
t.exports=function(e){if(window.FileReader){var t=document.getElementById("drop-zone")
i(t),t.ondrop=function(t){r(t,e)},o.write("Drop a GPX file"),o.add("or")}else o.write("Your browser does not support the HTML5 FileReader.")}},{"./msg":13,"./verify-dropped":16}],13:[function(e,t,n){n.write=function(e){var t=document.getElementById("msg")
t.innerHTML=e},n.add=function(e){var t=document.getElementById("msg"),n=t.innerHTML
t.innerHTML=n+"<br/>"+e}},{}],14:[function(e,t,n){function r(e,t){u(0,e.children,[],function(e){t(e)})}function o(e,t){c(0,e.children,[],function(e){t(e)})}function s(e,t){f(0,e.children,[],function(e){t(e)})}function a(e,t){var n={},r=e.attributes
...
n.time=Date.parse(s)}t(n.lat&&n.lon?n:null)}function u(e,t,n,r){e===t.length?r(n):"trk"===t[e].tagName?o(t[e],function(i){i.forEach(function(e){n.push(e)}),u(e+1,t,n,r)}):u(e+1,t,n,r)}function c(e,t,n,r){e===t.length?r(n):"trkseg"===t[e].tagName?s(t[e],function(i){i.forEach(function(e){n.push(e)}),c(e+1,t,n,r)}):c(e+1,t,n,r)}function f(e,t,n,r){e===t.length?r(n):"trkpt"===t[e].tagName?a(t[e],function(i){i&&n.push(i),Math.floor(e/1e3)===e/1e3?setTimeout(function(){l.write("Parsed "+e+" of "+t.length+" points"),f(e+1,t,n,r)},1):f(e+1,t,n,r)}):f(e+1,t,n,r)}var l=e("./msg")
t.exports=function(e,t){var n=e.children[0]
"gpx"!==n.nodeName?t("Not a valid GPX file"):r(n,function(e){l.write("Done parsing"),t(null,e)})}},{"./msg":13}],15:[function(e,t,n){function r(e,t){if(window.DOMParser){var n=new window.DOMParser
...
n.onload=function(){r(n.result,function(e,n){t(e,n)})},n.readAsText(e)}},{}],16:[function(e,t,n){function r(e){return"gpx"===e.name.split(".")[1]?(i.write("Document is a GPX file"),!0):(i.write("Document is not a GPX file"),!1)}var i=e("./msg"),o=e("./read-xml"),s=e("./parse-gpx")
t.exports=function(e,t){i.write("Verifying document..."),r(e)&&o(e,function(e,n){e?i.write(e):s(n,function(e,n){e?i.write(e):t.emit("gpx-parsed",n)})})}},{"./msg":13,"./parse-gpx":14,"./read-xml":15}],17:[function(e,t,n){var r=r||function(e){"use strict"
...
setTimeout(t,f)},p=function(e,t,n){t=[].concat(t)
for(var r=t.length;r--;){var i=e["on"+t[r]]
if("function"==typeof i)try{i.call(e,n||e)}catch(o){u(o)}}},v=function(e){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)?new Blob([String.fromCharCode(65279),e],{type:e.type}):e},d=function(t,u,f){f||(t=v(t))
var d,m=this,h=t.type,g=h===c,y=function(){p(m,"writestart progress write writeend".split(" "))},w=function(){if((a||g&&s)&&e.FileReader){var r=new FileReader
return r.onloadend=function(){var t=a?r.result:r.result.replace(/^data:[^;]*;/,"data:attachment/file;"),n=e.open(t,"_blank")
n||(e.location.href=t),t=void 0,m.readyState=m.DONE,y()},r.readAsDataURL(t),void(m.readyState=m.INIT)}if(d||(d=n().createObjectURL(t)),g)e.location.href=d
else{var i=e.open(d,"_blank")
i||(e.location.href=d)}m.readyState=m.DONE,y(),l(d)}
return m.readyState=m.INIT,i?(d=n().createObjectURL(t),void setTimeout(function(){r.href=d,r.download=u,o(r),y(),l(d),m.readyState=m.DONE})):void w()},m=d.prototype,h=function(e,t,n){return new d(e,t||e.name||"download",n)}
...
r(n,e)},n.blob=function(e,t){r(t,e)}},{}]},{},[2])
