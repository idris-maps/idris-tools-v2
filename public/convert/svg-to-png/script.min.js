...
console.log(a),window.onload=function(){i()}},{"../../components/convert-svg-to-png":3,"../../components/drop-zone-svg":5}],3:[function(t,e,n){function i(t,e,n){t.toBlob(function(t){s.blob(e.name+".png",t),n()})}var r=t("./lib/html"),a=t("canvg-browser"),s=t("../utils/save")
e.exports=function(t,e,n){r.init(t,function(){var t={ignoreMouse:!0,ignoreAnimation:!0},n=document.getElementById("canvas")
a(n,e.svg,t),1!==n.width&&1!==n.height?i(n,e):r.cannot()})}},{"../utils/save":12,"./lib/html":4,"canvg-browser":13}],4:[function(t,e,n){n.init=function(t,e){var n=document.getElementById(t)
...
for(r.lastIndex=e,r.exec(t);n=r.exec(t);)if(i.push(n),n[1])return i}var v=/[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,y=new RegExp("[\\-\\.0-9"+v.source.slice(1,-1)+"·̀-ͯ\\u203F-⁀]"),g=new RegExp("^"+v.source+y.source+"*(?::"+v.source+y.source+"*)?$"),b=0,x=1,w=2,E=3,P=4,N=5,T=6,C=7
