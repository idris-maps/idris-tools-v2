...
r(n,e)}},{}],16:[function(e,t,n){!function(e){"use strict"
...
var a=0,u=!1
this.parse=function(e,c,l){function f(e){w.push(e),L=a}function d(t){return l?p():("undefined"==typeof t&&(t=e.substr(a)),k.push(t),a=m,f(k),b&&v(),p())}function h(t){a=t,f(k),k=[],x=e.indexOf(n,a)}function p(e){return{data:w,errors:E,meta:{delimiter:t,linebreak:n,aborted:u,truncated:!!e,cursor:L+(c||0)}}}function v(){i(p()),w=[],E=[]}if("string"!=typeof e)throw"Input must be a string"
...
if(o&&I>=o)return w=w.slice(0,o),p(!0)}}return p()}for(var S=e.indexOf(t,a),x=e.indexOf(n,a);;)if('"'!=e[a])if(r&&0===k.length&&e.substr(a,_)===r){if(-1==x)return p()
a=x+y,x=e.indexOf(n,a),S=e.indexOf(t,a)}else if(-1!==S&&(x>S||-1===x))k.push(e.substring(a,S)),a=S+g,S=e.indexOf(t,a)
else{if(-1===x)break
if(k.push(e.substring(a,x)),h(x+y),b&&(v(),u))return p()
...
return d(R)}if('"'!=e[T+1]){if(e[T+1]==t){k.push(e.substring(a,T).replace(/""/g,'"')),a=T+1+g,S=e.indexOf(t,a),x=e.indexOf(n,a)
break}if(e.substr(T+1,y)===n){if(k.push(e.substring(a,T).replace(/""/g,'"')),h(T+1+y),S=e.indexOf(t,a),b&&(v(),u))return p()
