...
return r}({1:[function(e,t,n){function o(){var e=window.innerHeight-document.getElementById("header").offsetHeight
document.getElementById("map").style.height=e+"px"}var r=e("../../components/draw")
window.onload=function(){o(),r("map")},window.onresize=function(){o()}},{"../../components/draw":2}],2:[function(e,t,n){var o=e("./lib/init")
t.exports=function(e){o(e)}},{"./lib/init":5}],3:[function(e,t,n){function o(e,t){if("rectangle"===e){var n="Polygon",o=[]
...
n.push(r)}return{type:"FeatureCollection",features:n}}}},{}],4:[function(e,t,n){var o="",r=e("../../utils/save")
...
n.shown=!1,n.map=e.map,n.show=function(){n.shown||(n.map.addControl(new t),n.shown=!0)}}},{"../../utils/save":7}],5:[function(e,t,n){function o(){var e=document.getElementsByClassName("leaflet-draw-draw-circle")[0]
...
return map.addControl(n),o(),t.map.on("draw:created",function(e){a.onDrawCreated(e,t)}),t.drawn.on("click",function(e){a.onDrawnClick(e,t)}),t.toGeoJSON=function(){return t.data.toGeoJSON(t.drawn)},t}},{"./Data":3,"./download-button":4,"./on-event":6}],6:[function(e,t,n){n.onDrawCreated=function(e,t){var n=e.layer
...
if("function"==typeof r)try{r.call(e,n||e)}catch(a){d(a)}}},f=function(e){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)?new Blob([String.fromCharCode(65279),e],{type:e.type}):e},y=function(t,d,p){p||(t=f(t))
var y,v=this,m=t.type,w=m===u,g=function(){s(v,"writestart progress write writeend".split(" "))},h=function(){if((l||w&&i)&&e.FileReader){var o=new FileReader
return o.onloadend=function(){var t=l?o.result:o.result.replace(/^data:[^;]*;/,"data:attachment/file;"),n=e.open(t,"_blank")
n||(e.location.href=t),t=void 0,v.readyState=v.DONE,g()},o.readAsDataURL(t),void(v.readyState=v.INIT)}if(y||(y=n().createObjectURL(t)),w)e.location.href=y
else{var r=e.open(y,"_blank")
r||(e.location.href=y)}v.readyState=v.DONE,g(),c(y)}
return v.readyState=v.INIT,r?(y=n().createObjectURL(t),void setTimeout(function(){o.href=y,o.download=d,a(o),g(),c(y),v.readyState=v.DONE})):void h()},v=y.prototype,m=function(e,t,n){return new y(e,t||e.name||"download",n)}
...
o(n,e)},n.blob=function(e,t){o(t,e)}},{}]},{},[1])
