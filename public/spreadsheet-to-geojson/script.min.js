...
break
default:o=Array.prototype.slice.call(arguments,1),n.apply(this,o)}else if(s(n))for(o=Array.prototype.slice.call(arguments,1),l=n.slice(),r=l.length,u=0;r>u;u++)l[u].apply(this,o)
...
if(i(t))return 1
if(t)return t.length}return 0},r.listenerCount=function(e,t){return e.listenerCount(t)}},{}],2:[function(e,t,n){function r(){i("converter",function(e){o("converter",e,function(){r()})})}var i=e("../../components/paste-zone-csv/index"),o=e("../../components/convert-csv/index")
window.onload=function(){r()}},{"../../components/convert-csv/index":3,"../../components/paste-zone-csv/index":8}],3:[function(e,t,n){function r(e){u.header(e.divId,e.data,function(){l.header(function(t){t?(e.hasHead(),i(e)):u.setHead(e.divId,e.data,function(){l.setHead(e.nbCols,function(t){e.setHead(t),i(e)})})})})}function i(e){u.geoCol(e.divId,function(){l.geoCol(function(t){t?s(e):o(e)})})}function o(e){u.llCol(e.divId,e.head,function(){l.llCol(function(t,n){e.setLL(t,n,function(){e.geojson(function(t){f.json("collection.json",t),e.evt.emit("csv-converted")})})})})}function s(e){u.wktCol(e.divId,e.head,function(){l.wktCol(function(t){console.log(e),e.setWKT(t,function(){e.geojson(function(t){f.json("collection.json",t),e.evt.emit("csv-converted")})})})})}var a=e("./lib/Conf"),u=e("./lib/html"),l=e("./lib/ctrl"),c=e("./lib/parse"),f=e("../utils/save"),h=e("events").EventEmitter
t.exports=function(e,t,n){var i=new h
u.parsing(e,function(){c(t,function(t){if(t.errors.length>0)u.parseErrors(e,t.errors)
else{var o=new a(e,t.data,i)
r(o),o.evt.on("csv-converted",function(){n()})}})})}},{"../utils/save":11,"./lib/Conf":4,"./lib/ctrl":5,"./lib/html":6,"./lib/parse":7,events:1}],4:[function(e,t,n){var r=e("wellknown")
...
t.features.push(n)}}),e(t)},this}},{wellknown:13}],5:[function(e,t,n){n.header=function(e){var t=document.getElementById("csv-header-yes"),n=document.getElementById("csv-header-no")
...
t.exports=function(e,t){r.parse(e,{complete:function(e){t(e)}})}},{papaparse:12}],8:[function(e,t,n){var r=e("./lib/html"),i=e("./lib/ctrl")
t.exports=function(e,t){r(e,function(){i(function(e){t(e)})})}},{"./lib/ctrl":9,"./lib/html":10}],9:[function(e,t,n){t.exports=function(e){var t=document.getElementById("paste-area"),n=document.getElementById("paste-done"),r=document.getElementById("paste-error")
n.onclick=function(){console.log("click"),t.value?e(t.value):r.innerHTML="Paste area is empty"}}},{}],10:[function(e,t,n){t.exports=function(e,t){var n=document.getElementById(e)
n.innerHTML='<p>Paste data with lat/lng columns or a WKT column</p><textarea id="paste-area"></textarea><br/><button id="paste-done">Done</button><p id="paste-error"></p>',t()}},{}],11:[function(e,t,n){var r=r||function(e){"use strict"
...
e.dispatchEvent(t)},s=/constructor/i.test(e.HTMLElement)||e.safari,a=/CriOS\/[\d]+/.test(navigator.userAgent),u=function(t){(e.setImmediate||e.setTimeout)(function(){throw t},0)},l="application/octet-stream",c=4e4,f=function(e){var t=function(){"string"==typeof e?n().revokeObjectURL(e):e.remove()}
setTimeout(t,c)},h=function(e,t,n){t=[].concat(t)
for(var r=t.length;r--;){var i=e["on"+t[r]]
if("function"==typeof i)try{i.call(e,n||e)}catch(o){u(o)}}},d=function(e){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)?new Blob([String.fromCharCode(65279),e],{type:e.type}):e},p=function(t,u,c){c||(t=d(t))
var p,v=this,m=t.type,g=m===l,_=function(){h(v,"writestart progress write writeend".split(" "))},y=function(){if((a||g&&s)&&e.FileReader){var r=new FileReader
return r.onloadend=function(){var t=a?r.result:r.result.replace(/^data:[^;]*;/,"data:attachment/file;"),n=e.open(t,"_blank")
n||(e.location.href=t),t=void 0,v.readyState=v.DONE,_()},r.readAsDataURL(t),void(v.readyState=v.INIT)}if(p||(p=n().createObjectURL(t)),g)e.location.href=p
else{var i=e.open(p,"_blank")
i||(e.location.href=p)}v.readyState=v.DONE,_(),f(p)}
return v.readyState=v.INIT,i?(p=n().createObjectURL(t),void setTimeout(function(){r.href=p,r.download=u,o(r),_(),f(p),v.readyState=v.DONE})):void y()},v=p.prototype,m=function(e,t,n){return new p(e,t||e.name||"download",n)}
...
r(n,e)},n.blob=function(e,t){r(t,e)}},{}],12:[function(e,t,n){!function(e){"use strict"
function n(t,n){if(n=n||{},n.worker&&L.WORKERS_SUPPORTED){var r=f()
return r.userStep=n.step,r.userChunk=n.chunk,r.userComplete=n.complete,r.userError=n.error,n.step=_(n.step),n.chunk=_(n.chunk),n.complete=_(n.complete),n.error=_(n.error),delete n.worker,void r.postMessage({input:t,config:n,workerId:r.id})}var i=null
return"string"==typeof t?i=n.download?new o(n):new a(n):(e.File&&t instanceof File||t instanceof Object)&&(i=new s(n)),i.stream(t)}function r(e,t){function n(){"object"==typeof t&&("string"==typeof t.delimiter&&1==t.delimiter.length&&-1==L.BAD_DELIMITERS.indexOf(t.delimiter)&&(u=t.delimiter),("boolean"==typeof t.quotes||t.quotes instanceof Array)&&(a=t.quotes),"string"==typeof t.newline&&(l=t.newline))}function r(e){if("object"!=typeof e)return[]
var t=[]
...
t.length>0&&(n+=l)}for(var a=0;a<t.length;a++){for(var c=r?e.length:t[a].length,f=0;c>f;f++){f>0&&(n+=u)
var h=r&&i?e[f]:f
n+=o(t[a][h],f)}a<t.length-1&&(n+=l)}return n}function o(e,t){if("undefined"==typeof e||null===e)return""
e=e.toString().replace(/"/g,'""')
var n="boolean"==typeof a&&a||a instanceof Array&&a[t]||s(e,L.BAD_DELIMITERS)||e.indexOf(u)>-1||" "==e.charAt(0)||" "==e.charAt(e.length-1)
...
if(w)e.postMessage({results:i,workerId:L.WORKER_ID,finished:s})
else if(_(this._config.chunk)){if(this._config.chunk(i,this._handle),this._paused)return
i=void 0,this._completeResults=void 0}return this._config.step||this._config.chunk||(this._completeResults.data=this._completeResults.data.concat(i.data),this._completeResults.errors=this._completeResults.errors.concat(i.errors),this._completeResults.meta=i.meta),!s||!_(this._config.complete)||i&&i.meta.aborted||this._config.complete(this._completeResults),s||i&&i.meta.paused||this._nextChunk(),i}},this._sendError=function(t){_(this._config.error)?this._config.error(t):w&&this._config.error&&e.postMessage({workerId:L.WORKER_ID,error:t,finished:!1})}}function o(e){function t(e){var t=e.getResponseHeader("Content-Range")
return parseInt(t.substr(t.lastIndexOf("/")+1))}e=e||{},e.chunkSize||(e.chunkSize=L.RemoteChunkSize),i.call(this,e)
var n
...
this._sendError(t)}}function s(e){e=e||{},e.chunkSize||(e.chunkSize=L.LocalChunkSize),i.call(this,e)
...
return n=e?n.substr(e):"",this._finished=!n,this.parseChunk(t)}}}function u(e){function t(){if(w&&h&&(u("Delimiter","UndetectableDelimiter","Unable to auto-detect delimiting character; defaulted to '"+L.DefaultDelimiter+"'"),h=!1),e.skipEmptyLines)for(var t=0;t<w.data.length;t++)1==w.data[t].length&&""==w.data[t][0]&&w.data.splice(t--,1)
...
"true"==i||"TRUE"==i?w.data[t][r]=!0:"false"==i||"FALSE"==i?w.data[t][r]=!1:w.data[t][r]=a(i)}e.header&&(r>=b.length?(n.__parsed_extra||(n.__parsed_extra=[]),n.__parsed_extra.push(w.data[t][r])):n[b[r]]=w.data[t][r])}e.header&&(w.data[t]=n,r>b.length?u("FieldMismatch","TooManyFields","Too many fields: expected "+b.length+" fields but parsed "+r,t):r<b.length&&u("FieldMismatch","TooFewFields","Too few fields: expected "+b.length+" fields but parsed "+r,t))}return e.header&&w.meta&&(w.meta.fields=b),w}function o(t){for(var n,r,i,o=[",","	","|",";",L.RECORD_SEP,L.UNIT_SEP],s=0;s<o.length;s++){var a=o[s],u=0,c=0
i=void 0
for(var f=new l({delimiter:a,preview:10}).parse(t),h=0;h<f.data.length;h++){var d=f.data[h].length
c+=d,"undefined"!=typeof i?d>1&&(u+=Math.abs(d-i),i=d):i=d}f.data.length>0&&(c/=f.data.length),("undefined"==typeof r||r>u)&&c>1.99&&(r=u,n=a)}return e.delimiter=n,{successful:!!n,bestDelimiter:n}}function s(e){e=e.substr(0,1048576)
var t=e.split("\r")
if(1==t.length)return"\n"
for(var n=0,r=0;r<t.length;r++)"\n"==t[r][0]&&n++
return n>=t.length/2?"\r\n":"\r"}function a(e){var t=d.test(e)
return t?parseFloat(e):e}function u(e,t,n,r){w.errors.push({type:e,code:t,message:n,row:r})}var c,f,h,d=/^\s*-?(\d*\.?\d+|\d+\.?\d*)(e[-+]?\d+)?\s*$/i,p=this,v=0,g=!1,y=!1,b=[],w={data:[],errors:[],meta:{}}
if(_(e.step)){var k=e.step
e.step=function(r){if(w=r,n())t()
else{if(t(),0==w.data.length)return
v+=r.data.length,e.preview&&v>e.preview?f.abort():k(w,p)}}}this.parse=function(n,r,i){if(e.newline||(e.newline=s(n)),h=!1,!e.delimiter){var a=o(n)
a.successful?e.delimiter=a.bestDelimiter:(h=!0,e.delimiter=L.DefaultDelimiter),w.meta.delimiter=e.delimiter}var u=m(e)
return e.preview&&e.header&&u.preview++,c=n,f=new l(u),w=f.parse(c,r,i),t(),g?{meta:{paused:!0}}:w||{meta:{paused:!1}}},this.paused=function(){return g},this.pause=function(){g=!0,f.abort(),c=c.substr(f.getCharIndex())},this.resume=function(){g=!1,p.streamer.parseChunk(c)},this.aborted=function(){return y},this.abort=function(){y=!0,f.abort(),w.meta.aborted=!0,_(e.complete)&&e.complete(w),c=""}}function l(e){e=e||{}
var t=e.delimiter,n=e.newline,r=e.comments,i=e.step,o=e.preview,s=e.fastMode
if(("string"!=typeof t||L.BAD_DELIMITERS.indexOf(t)>-1)&&(t=","),r===t)throw"Comment character same as delimiter"
r===!0?r="#":("string"!=typeof r||L.BAD_DELIMITERS.indexOf(r)>-1)&&(r=!1),"\n"!=n&&"\r"!=n&&"\r\n"!=n&&(n="\n")
var a=0,u=!1
this.parse=function(e,l,c){function f(e){w.push(e),I=a}function h(t){return c?p():("undefined"==typeof t&&(t=e.substr(a)),E.push(t),a=m,f(E),b&&v(),p())}function d(t){a=t,f(E),E=[],S=e.indexOf(n,a)}function p(e){return{data:w,errors:k,meta:{delimiter:t,linebreak:n,aborted:u,truncated:!!e,cursor:I+(l||0)}}}function v(){i(p()),w=[],k=[]}if("string"!=typeof e)throw"Input must be a string"
var m=e.length,g=t.length,_=n.length,y=r.length,b="function"==typeof i
a=0
var w=[],k=[],E=[],I=0
if(!e)return p()
if(s||s!==!1&&-1===e.indexOf('"')){for(var L=e.split(n),C=0;C<L.length;C++){var E=L[C]
if(a+=E.length,C!==L.length-1)a+=n.length
else if(c)return p()
if(!r||E.substr(0,y)!=r){if(b){if(w=[],f(E.split(t)),v(),u)return p()}else f(E.split(t))
if(o&&C>=o)return w=w.slice(0,o),p(!0)}}return p()}for(var x=e.indexOf(t,a),S=e.indexOf(n,a);;)if('"'!=e[a])if(r&&0===E.length&&e.substr(a,y)===r){if(-1==S)return p()
a=S+_,S=e.indexOf(n,a),x=e.indexOf(t,a)}else if(-1!==x&&(S>x||-1===S))E.push(e.substring(a,x)),a=x+g,x=e.indexOf(t,a)
else{if(-1===S)break
if(E.push(e.substring(a,S)),d(S+_),b&&(v(),u))return p()
if(o&&w.length>=o)return p(!0)}else{var T=a
for(a++;;){var T=e.indexOf('"',T+1)
if(-1===T)return c||k.push({type:"Quotes",code:"MissingQuotes",message:"Quoted field unterminated",row:w.length,index:a}),h()
if(T===m-1){var R=e.substring(a,T).replace(/""/g,'"')
return h(R)}if('"'!=e[T+1]){if(e[T+1]==t){E.push(e.substring(a,T).replace(/""/g,'"')),a=T+1+g,x=e.indexOf(t,a),S=e.indexOf(n,a)
break}if(e.substr(T+1,_)===n){if(E.push(e.substring(a,T).replace(/""/g,'"')),d(T+1+_),x=e.indexOf(t,a),b&&(v(),u))return p()
if(o&&w.length>=o)return p(!0)
break}}else T++}}return h()},this.abort=function(){u=!0},this.getCharIndex=function(){return a}}function c(){var e=document.getElementsByTagName("script")
return e.length?e[e.length-1].src:""}function f(){if(!L.WORKERS_SUPPORTED)return!1
if(!k&&null===L.SCRIPT_PATH)throw new Error("Script path cannot be determined automatically when Papa Parse is loaded asynchronously. You need to set Papa.SCRIPT_PATH manually.")
var t=L.SCRIPT_PATH||y
t+=(-1!==t.indexOf("?")?"&":"?")+"papaworker"
var n=new e.Worker(t)
return n.onmessage=h,n.id=I++,E[n.id]=n,n}function h(e){var t=e.data,n=E[t.workerId],r=!1
if(t.error)n.userError(t.error,t.file)
else if(t.results&&t.results.data){var i=function(){r=!0,d(t.workerId,{data:[],errors:[],meta:{aborted:!0}})},o={abort:i,pause:p,resume:p}
if(_(n.userStep)){for(var s=0;s<t.results.data.length&&(n.userStep({data:[t.results.data[s]],errors:t.results.errors,meta:t.results.meta},o),!r);s++);delete t.results}else _(n.userChunk)&&(n.userChunk(t.results,o,t.file),delete t.results)}t.finished&&!r&&d(t.workerId,t.results)}function d(e,t){var n=E[e]
_(n.userComplete)&&n.userComplete(t),n.terminate(),delete E[e]}function p(){throw"Not implemented."}function v(t){var n=t.data
if("undefined"==typeof L.WORKER_ID&&n&&(L.WORKER_ID=n.workerId),"string"==typeof n.input)e.postMessage({workerId:L.WORKER_ID,results:L.parse(n.input,n.config),finished:!0})
else if(e.File&&n.input instanceof File||n.input instanceof Object){var r=L.parse(n.input,n.config)
r&&e.postMessage({workerId:L.WORKER_ID,results:r,finished:!0})}}function m(e){if("object"!=typeof e)return e
var t=e instanceof Array?[]:{}
for(var n in e)t[n]=m(e[n])
return t}function g(e,t){return function(){e.apply(t,arguments)}}function _(e){return"function"==typeof e}var y,b=!e.document&&!!e.postMessage,w=b&&/(\?|&)papaworker(=|&|$)/.test(e.location.search),k=!1,E={},I=0,L={}
if(L.parse=n,L.unparse=r,L.RECORD_SEP=String.fromCharCode(30),L.UNIT_SEP=String.fromCharCode(31),L.BYTE_ORDER_MARK="\ufeff",L.BAD_DELIMITERS=["\r","\n",'"',L.BYTE_ORDER_MARK],L.WORKERS_SUPPORTED=!b&&!!e.Worker,L.SCRIPT_PATH=null,L.LocalChunkSize=10485760,L.RemoteChunkSize=5242880,L.DefaultDelimiter=",",L.Parser=l,L.ParserHandle=u,L.NetworkStreamer=o,L.FileStreamer=s,L.StringStreamer=a,"undefined"!=typeof t&&t.exports?t.exports=L:_(e.define)&&e.define.amd?define(function(){return L}):e.Papa=L,e.jQuery){var C=e.jQuery
C.fn.parse=function(t){function n(){if(0==s.length)return void(_(t.complete)&&t.complete())
var e=s[0]
if(_(t.before)){var n=t.before(e.file,e.inputElem)
if("object"==typeof n){if("abort"==n.action)return void r("AbortError",e.file,e.inputElem,n.reason)
if("skip"==n.action)return void i()
"object"==typeof n.config&&(e.instanceConfig=C.extend(e.instanceConfig,n.config))}else if("skip"==n)return void i()}var o=e.instanceConfig.complete
e.instanceConfig.complete=function(t){_(o)&&o(t,e.file,e.inputElem),i()},L.parse(e.file,e.instanceConfig)}function r(e,n,r,i){_(t.error)&&t.error({name:e},n,r,i)}function i(){s.splice(0,1),n()}var o=t.config||{},s=[]
...
for(var r=0;r<this.files.length;r++)s.push({file:this.files[r],inputElem:this,instanceConfig:C.extend({},o)})}),n(),this}}w?e.onmessage=v:L.WORKERS_SUPPORTED&&(y=c(),document.body?document.addEventListener("DOMContentLoaded",function(){k=!0},!0):k=!0),o.prototype=Object.create(i.prototype),o.prototype.constructor=o,s.prototype=Object.create(i.prototype),s.prototype.constructor=s,a.prototype=Object.create(a.prototype),a.prototype.constructor=a}("undefined"!=typeof window?window:this)},{}],13:[function(e,t,n){function r(e){function t(e){var t=m.substring(_).match(e)
return t?(_+=t[0].length,t[0]):null}function n(e){return e&&g.match(/\d+/)&&(e.crs={type:"name",properties:{name:"urn:ogc:def:crs:EPSG::"+g}}),e}function r(){t(/^\s*/)}function i(){r()
...
m="MULTIPOINT ("+e+")"
var n=i()
return n?(r(),{type:"MultiPoint",coordinates:n}):null}function l(){if(!t(/^(multilinestring)/i))return null
r()
var e=i()
return e?(r(),{type:"MultiLineString",coordinates:e}):null}function c(){if(!t(/^(linestring(\sz)?)/i))return null
if(r(),!t(/^(\()/))return null
var e=o()
return e&&t(/^(\))/)?{type:"LineString",coordinates:e}:null}function f(){if(!t(/^(polygon(\sz)?)/i))return null
r()
var e=i()
return e?{type:"Polygon",coordinates:e}:null}function h(){if(!t(/^(multipolygon)/i))return null
r()
var e=i()
return e?{type:"MultiPolygon",coordinates:e}:null}function d(){var e,n=[]
if(!t(/^(geometrycollection)/i))return null
if(r(),!t(/^(\()/))return null
for(;e=p();)n.push(e),r(),t(/^(,)/),r()
return t(/^(\))/)?{type:"GeometryCollection",geometries:n}:null}function p(){return a()||c()||f()||u()||l()||h()||d()}var v=e.split(";"),m=v.pop(),g=(v.shift()||"").split("=").pop(),_=0
