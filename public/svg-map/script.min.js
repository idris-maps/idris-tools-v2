...
return n.forEach(function(t,r){r<n.length-1&&(e=0===r?t:e+"-"+t)}),e}function o(t,n){l(t,function(t,e){t?(u.write("Document is a valid GeoJSON"),n(!0)):(u.add("Document is not a valid GeoJSON"),u.add("Errors: "),e.forEach(function(t){"String"!=typeof t&&(t=t.toString()),u.add(t)}),n(!1))})}function i(t){return"application/json"===t.type?(u.write("Document is a JSON file"),u.add("Verifying if it is a valid GeoJSON file..."),!0):(u.write("Document is not a JSON file"),!1)}var u=t("./msg"),a=t("./read-json"),l=t("./validate-geojson"),s=t("./separate-geotypes"),c=t("idris-ensure-clockwise")
...
n.innerHTML=e.outerHTML(),e.rendered=!0},e.redraw=function(){e.rendered&&e.render(e.renderDivId)},e.destroy=function(){if(e.rendered){for(var t=document.getElementById(e.renderDivId);myNode.firstChild;)t.removeChild(t.firstChild)
...
e.fromFeature=function(t){return r(o.fromFeature(t))},e.fromFeatureCollection=function(t){return r(o.fromFeatureCollection(t))},e.fromGeometry=function(t){return r(o.fromGeometry(t))}},{"./get-all-points":37}],39:[function(t,n,e){var r=t("./utils")
e.getAll=function(t){var n=[]
for(k in t[0].properties)n.push(k)
return n},e.getValues=function(t,n){var e=[]
return t.forEach(function(t){e.push(t.properties[n])}),e.sort(function(t,n){return t-n})},e.getUniqValues=function(t,n){var e=[]
return t.forEach(function(t){e.push(t.properties[n])}),r.uniq(e)},e.numericValues=function(t,n){var e=!0
return t.forEach(function(t){t.properties[n]&&isNaN(t.properties[n])&&(e=!1)}),e}},{"./utils":40}],40:[function(t,n,e){e.isGeom=function(t){var n=!1,e=["Point","MultiPoint","LineString","MultiLineString","Polygon","MultiPolygon"]
return e.forEach(function(e){t.type===e&&(n=!0)}),n},e.uniq=function(t){var n=[]
return t.forEach(function(t){var e=!1
n.forEach(function(n){t===n&&(e=!0)}),e||n.push(t)}),n.sort(),n}},{}],41:[function(t,n,e){function r(t){t.sort(function(t,n){return t-n})
...
r(e,t)}},{}],43:[function(t,n,e){!function(t,r){"object"==typeof e&&"undefined"!=typeof n?r(e):"function"==typeof define&&define.amd?define(["exports"],r):r(t.d3=t.d3||{})}(this,function(t){"use strict"
...
return i>=V?o*=10:i>=R?o*=5:i>=G&&(o*=2),t>n?-o:o}function h(t){return Math.ceil(Math.log(t.length)/Math.LN2)+1}function d(){function t(t){var o,i,u=t.length,a=new Array(u)
...
for(o=0;u>o;++o)i=a[o],i>=s&&c>=i&&d[F(f,i,0,y)].push(t[o])
...
return a+(l-a)*(o-u)}}function g(t,e,r){return t=T.call(t,i).sort(n),Math.ceil((r-e)/(2*(m(t,.75)-m(t,.25))*Math.pow(t.length,-1/3)))}function v(t,n,e){return Math.ceil((e-n)/(3.5*a(t)*Math.pow(t.length,-1/3)))}function b(t,n){var e,r,o=-1,i=t.length
...
n.polygonEnd()}function f(){oe.point=y}function p(){h(tn,nn)}function y(t,n){oe.point=h,tn=t,nn=n,t*=Gn,n*=Gn,en=t,rn=Dn(n=n/2+Tn),on=$n(n)}function h(t,n){t*=Gn,n*=Gn,n=n/2+Tn
...
t[0]/=n,t[1]/=n,t[2]/=n}function S(t,n){hn.push(dn=[un=t,ln=t]),an>n&&(an=n),n>sn&&(sn=n)}function w(t,n){var e=m([t*Gn,n*Gn])
if(yn){var r=v(yn,e),o=[r[1],-r[0],0],i=v(o,r)
x(i),i=d(i)
var u,a=t-cn,l=a>0?1:-1,s=i[0]*Rn*l,c=zn(a)>180
c^(s>l*cn&&l*t>s)?(u=i[1]*Rn,u>sn&&(sn=u)):(s=(s+360)%360-180,c^(s>l*cn&&l*t>s)?(u=-i[1]*Rn,an>u&&(an=u)):(an>n&&(an=n),n>sn&&(sn=n))),c?cn>t?k(un,t)>k(un,ln)&&(ln=t):k(t,ln)>k(un,ln)&&(un=t):ln>=un?(un>t&&(un=t),t>ln&&(ln=t)):t>cn?k(un,t)>k(un,ln)&&(ln=t):k(t,ln)>k(un,ln)&&(un=t)}else S(t,n)
yn=e,cn=t}function M(){ae.point=w}function P(){dn[0]=un,dn[1]=ln,ae.point=S,yn=null}function L(t,n){if(yn){var e=t-cn
ue.add(zn(e)>180?e+(e>0?360:-360):e)}else fn=t,pn=n
oe.point(t,n),w(t,n)}function N(){oe.lineStart()}function B(){L(fn,pn),oe.lineEnd(),zn(ue)>Fn&&(un=-(ln=180)),dn[0]=un,dn[1]=ln,yn=null}function k(t,n){return(n-=t)<0?n+360:n}function _(t,n){return t[0]-n[0]}function C(t,n){return t[0]<=t[1]?t[0]<=n&&n<=t[1]:n<t[0]||t[1]<n}function O(t,n){t*=Gn,n*=Gn
var e=Dn(n)
F(e*Dn(t),e*$n(t),$n(n))}function F(t,n,e){++mn,vn+=(t-vn)/mn,bn+=(n-bn)/mn,En+=(e-En)/mn}function I(){se.point=A}function A(t,n){t*=Gn,n*=Gn
var e=Dn(n)
kn=e*Dn(t),_n=e*$n(t),Cn=$n(n),se.point=j,F(kn,_n,Cn)}function j(t,n){t*=Gn,n*=Gn
var e=Dn(n),r=e*Dn(t),o=e*$n(t),i=$n(n),u=Hn(Yn((u=_n*i-Cn*o)*u+(u=Cn*r-kn*i)*u+(u=kn*o-_n*r)*u),kn*r+_n*o+Cn*i)
gn+=u,xn+=u*(kn+(kn=r)),Sn+=u*(_n+(_n=o)),wn+=u*(Cn+(Cn=i)),F(kn,_n,Cn)}function T(){se.point=O}function V(){se.point=G}function R(){z(Nn,Bn),se.point=O}function G(t,n){Nn=t,Bn=n,t*=Gn,n*=Gn,se.point=z
var e=Dn(n)
kn=e*Dn(t),_n=e*$n(t),Cn=$n(n),F(kn,_n,Cn)}function z(t,n){t*=Gn,n*=Gn
...
Mn+=p*a,Pn+=p*l,Ln+=p*s,gn+=y,xn+=y*(kn+(kn=r)),Sn+=y*(_n+(_n=i)),wn+=y*(Cn+(Cn=u)),F(kn,_n,Cn)}function q(t,n){return[t>An?t-Vn:-An>t?t+Vn:t,n]}function H(t,n,e){return(t%=Vn)?n||e?pe(J(t),U(n,e)):J(t):n||e?U(n,e):q}function D(t){return function(n,e){return n+=t,[n>An?n-Vn:-An>n?n+Vn:n,e]}}function J(t){var n=D(t)
...
null==o?(o=n+r*Vn,i=n-l/2):(o=W(u,o),i=W(u,i),(r>0?i>o:o>i)&&(o+=r*Vn))
for(var s,c=o;r>0?c>i:i>c;c-=l)s=d([u,-a*Dn(c),-a*$n(c)]),t.point(s[0],s[1])}}function W(t,n){n=m(n),n[0]-=t,x(n)
var e=o(-n[1])
return((-n[2]<0?-e:e)+Vn-Fn)%Vn}function $(t,n,e,r){this.x=t,this.z=n,this.o=e,this.e=r,this.v=!1,this.n=this.p=null}function X(t){if(n=t.length){for(var n,e,r=0,o=t[0];++r<n;)o.n=e=t[r],e.p=o,o=e
...
while((c=(c+u+4)%4)!==f)}else l.point(i[0],i[1])}function a(n,o){return zn(n[0]-t)<Fn?o>0?0:3:zn(n[0]-r)<Fn?o>0?2:1:zn(n[1]-e)<Fn?o>0?1:0:o>0?3:2}function l(t,n){return s(t.x,n.x)}function s(t,n){var e=a(t,1),r=a(n,1)
...
Ze+=o*(Se+t)/2,Qe+=o*(we+n)/2,tr+=o,o=we*t-Se*n,nr+=o*(Se+t),er+=o*(we+n),rr+=3*o,ft(Se=t,we=n)}function Et(t){this._context=t}function xt(){this._string=[]}function St(t){return"m0,"+t+"a"+t+","+t+" 0 1,1 0,"+-2*t+"a"+t+","+t+" 0 1,1 0,"+2*t+"z"}function wt(t){return t.length>1}function Mt(t,n){return((t=t.x)[0]<0?t[1]-jn-Fn:jn-t[1])-((n=n.x)[0]<0?n[1]-jn-Fn:jn-n[1])}function Pt(t){var n,e=NaN,r=NaN,o=NaN
return{lineStart:function(){t.lineStart(),n=1},point:function(i,u){var a=i>0?An:-An,l=zn(i-e)
zn(l-An)<Fn?(t.point(e,r=(r+u)/2>0?jn:-jn),t.point(o,r),t.lineEnd(),t.lineStart(),t.point(a,r),t.point(i,r),n=0):o!==a&&l>=An&&(zn(e-o)<Fn&&(e-=o*Fn),zn(i-a)<Fn&&(i-=a*Fn),r=Lt(e,r,i,u),t.point(o,r),t.lineEnd(),t.lineStart(),t.point(a,r),n=0),t.point(e=i,r=u),o=a},lineEnd:function(){t.lineEnd(),e=r=NaN},clean:function(){return 2-n}}}function Lt(t,n,e,r){var o,i,u=$n(t-e)
return zn(u)>Fn?qn(($n(n)*(i=Dn(r))*$n(e)-$n(r)*(o=Dn(n))*$n(t))/(o*i*u)):(n+r)/2}function Nt(t,n,e,r){var o
...
else if(zn(t[0]-n[0])>Fn){var i=t[0]<n[0]?An:-An
...
return null!=i&&t.clipExtent(i),t.scale(150*a).translate([l,s])}function Ct(t,n,e){return _t(t,[[0,0],n],e)}function Ot(t){return Bt({point:function(n,e){n=t(n,e),this.stream.point(n[0],n[1])}})}function Ft(t,n){function e(r,o,u,a,l,s,c,f,p,y,h,d,m,g){var v=c-r,b=f-o,E=v*v+b*b
if(E>4*n&&m--){var x=a+y,S=l+h,w=s+d,M=Yn(x*x+S*S+w*w),P=i(w/=M),L=zn(zn(w)-1)<Fn||zn(u-p)<Fn?(u+p)/2:Hn(S,x),N=t(L,P),B=N[0],k=N[1],_=B-r,C=k-o,O=b*_-v*C;(O*O/E>n||zn((v*_+b*C)/E-.5)>.3||yr>a*y+l*h+s*d)&&(e(r,o,u,a,l,s,B,k,L,x/=M,S/=M,w,m,g),g.point(B,k),e(B,k,L,x,S,w,c,f,p,y,h,d,m,g))}}return function(n){function r(e,r){e=t(e,r),n.point(e[0],e[1])}function o(){v=NaN,w.point=i,n.lineStart()}function i(r,o){var i=m([r,o]),u=t(r,o)
...
return w}}function It(t){return At(function(){return t})()}function At(t){function n(t){return t=c(t[0]*Gn,t[1]*Gn),[t[0]*m+a,l-t[1]*m]}function e(t){return t=c.invert((t[0]-a)/m,(l-t[1])/m),t&&[t[0]*Rn,t[1]*Rn]}function r(t,n){return t=u(t,n),[t[0]*m+a,l-t[1]*m]}function o(){c=pe(s=H(x,S,w),u)
var t=u(b,E)
return a=g-t[0]*m,l=v+t[1]*m,i()}function i(){return h=d=null,n}var u,a,l,s,c,f,p,y,h,d,m=150,g=480,v=250,b=0,E=0,x=0,S=0,w=0,M=null,P=sr,L=null,N=Ge,B=.5,k=hr(r,B)
return n.stream=function(t){return h&&d===t?h:h=dr(P(s,k(N(d=t))))},n.clipAngle=function(t){return arguments.length?(P=+t?cr(M=t*Gn,6*Gn):(M=null,sr),i()):M*Rn},n.clipExtent=function(t){return arguments.length?(N=null==t?(L=f=p=y=null,Ge):Y(L=+t[0][0],f=+t[0][1],p=+t[1][0],y=+t[1][1]),i()):null==L?null:[[L,f],[p,y]]},n.scale=function(t){return arguments.length?(m=+t,o()):m},n.translate=function(t){return arguments.length?(g=+t[0],v=+t[1],o()):[g,v]},n.center=function(t){return arguments.length?(b=t[0]%360*Gn,E=t[1]%360*Gn,o()):[b*Rn,E*Rn]},n.rotate=function(t){return arguments.length?(x=t[0]%360*Gn,S=t[1]%360*Gn,w=t.length>2?t[2]%360*Gn:0,o()):[x*Rn,S*Rn,w*Rn]},n.precision=function(t){return arguments.length?(k=hr(r,B=t*t),i()):Yn(B)},n.fitExtent=function(t,e){return _t(n,t,e)},n.fitSize=function(t,e){return Ct(n,t,e)},function(){return u=t.apply(this,arguments),n.invert=u.invert&&e,o()}}function jt(t){var n=0,e=An/3,r=At(t),o=r(n,e)
return o.parallels=function(t){return arguments.length?r(n=t[0]*Gn,e=t[1]*Gn):[n*Rn,e*Rn]},o}function Tt(t){function n(t,n){return[t*e,$n(n)/e]}var e=Dn(t)
return n.invert=function(t,n){return[t/e,i(n*e)]},n}function Vt(t,n){function e(t,n){var e=Yn(u-2*o*$n(n))/o
return[e*$n(t*=o),a-e*Dn(t)]}var r=$n(t),o=(r+$n(n))/2
if(zn(o)<Fn)return Tt(t)
var u=1+r*(2*o-r),a=Yn(u)/o
return e.invert=function(t,n){var e=a-n
return[Hn(t,zn(e))/o*Xn(e),i((u-(t*t+e*e)*o*o)/(2*o))]},e}function Rt(t){var n=t.length
return{point:function(e,r){for(var o=-1;++o<n;)t[o].point(e,r)},sphere:function(){for(var e=-1;++e<n;)t[e].sphere()},lineStart:function(){for(var e=-1;++e<n;)t[e].lineStart()},lineEnd:function(){for(var e=-1;++e<n;)t[e].lineEnd()},polygonStart:function(){for(var e=-1;++e<n;)t[e].polygonStart()},polygonEnd:function(){for(var e=-1;++e<n;)t[e].polygonEnd()}}}function Gt(t){return function(n,e){var r=Dn(n),o=Dn(e),i=t(r*o)
return[i*o*$n(n),i*$n(e)]}}function zt(t){return function(n,e){var r=Yn(n*n+e*e),o=t(r),u=$n(o),a=Dn(o)
return[Hn(n*u,r*a),i(r&&e*u/r)]}}function qt(t,n){return[t,Kn(Zn((jn+n)/2))]}function Ht(t){var n,e=It(t),r=e.scale,o=e.translate,i=e.clipExtent
...
t=[[a[0]-u,a[1]-u],[a[0]+u,a[1]+u]]}return i(t),e},e.clipExtent(null)}function Dt(t){return Zn((jn+t)/2)}function Jt(t,n){function e(t,n){i>0?-jn+Fn>n&&(n=-jn+Fn):n>jn-Fn&&(n=jn-Fn)
var e=i/Wn(Dt(n),o)
...
return[Hn(t,zn(e))/o*Xn(e),2*qn(Wn(i/r,1/o))-jn]},e):qt}function Ut(t,n){return[t,n]}function Kt(t,n){function e(t,n){var e=i-n,r=o*t
return[e*$n(r),i-e*Dn(r)]}var r=Dn(t),o=t===n?$n(t):(r-Dn(n))/(n-t),i=r/o+t
return zn(o)<Fn?Ut:(e.invert=function(t,n){var e=i-n
return[Hn(t,zn(e))/o*Xn(e),i-Xn(o)*Yn(t*t+e*e)]},e)}function Wt(t,n){var e=Dn(n),r=Dn(t)*e
return[e*$n(t)/r,$n(n)/r]}function $t(t,n,e){return 1===t&&0===n&&0===e?Ge:Bt({point:function(r,o){this.stream.point(r*t+n,o*t+e)}})}function Xt(t,n){return[Dn(n)*$n(t),$n(n)]}function Yt(t,n){var e=Dn(n),r=1+Dn(t)*e
...
for(u=-(1/0),e=i.length-1,n=0,r=i[e];e>=n;r=o,++n)o=i[n],(a=k(r[1],o[0]))>u&&(u=a,un=o[0],ln=r[1])}return hn=dn=null,un===1/0||an===1/0?[[NaN,NaN],[NaN,NaN]]:[[un,an],[ln,sn]]},se={sphere:a,point:O,lineStart:I,lineEnd:T,polygonStart:function(){se.lineStart=V,se.lineEnd=R},polygonEnd:function(){se.lineStart=I,se.lineEnd=T}},ce=function(t){mn=gn=vn=bn=En=xn=Sn=wn=Mn=Pn=Ln=0,ne(t,se)
var n=Mn,e=Pn,r=Ln,o=n*n+e*e+r*r
return In>o&&(n=xn,e=Sn,r=wn,Fn>gn&&(n=vn,e=bn,r=En),o=n*n+e*e+r*r,In>o)?[NaN,NaN]:[Hn(e,n)*Rn,i(r/Yn(o))*Rn]},fe=function(t){return function(){return t}},pe=function(t,n){function e(e,r){return e=t(e,r),n(e[0],e[1])}return t.invert&&n.invert&&(e.invert=function(e,r){return e=n.invert(e,r),e&&t.invert(e[0],e[1])}),e}
q.invert=q
var ye,he,de,me,ge,ve,be,Ee,xe,Se,we,Me=function(t){function n(n){return n=t(n[0]*Gn,n[1]*Gn),n[0]*=Rn,n[1]*=Rn,n}return t=H(t[0]*Gn,t[1]*Gn,t.length>2?t[2]*Gn:0),n.invert=function(n){return n=t.invert(n[0]*Gn,n[1]*Gn),n[0]*=Rn,n[1]*=Rn,n},n},Pe=function(){function t(t,n){e.push(t=r(t,n)),t[0]*=Rn,t[1]*=Rn}function n(){var t=o.apply(this,arguments),n=i.apply(this,arguments)*Gn,l=u.apply(this,arguments)*Gn
return e=[],r=H(-t[0]*Gn,-t[1]*Gn,0).invert,K(a,n,l,1),t={type:"Polygon",coordinates:[e]},e=r=null,t}var e,r,o=fe([0,0]),i=fe(90),u=fe(6),a={point:t}
...
p>u&&(p=u)}return f>0&&(t[0]=a+f*y,t[1]=l+f*h),1>p&&(n[0]=a+p*y,n[1]=l+p*h),!0}}}}},Be=function(t,n){return zn(t[0]-n[0])<Fn&&zn(t[1]-n[1])<Fn},ke=function(t,n,e,r,o){var i,u,a=[],l=[]
...
return e={stream:function(e){return t&&n===e?t:t=Y(r,o,i,u)(n=e)},extent:function(a){return arguments.length?(r=+a[0][0],o=+a[0][1],i=+a[1][0],u=+a[1][1],t=n=null,e):[[r,o],[i,u]]}}},Fe=Qt(),Ie={sphere:a,point:a,lineStart:Z,lineEnd:a,polygonStart:a,polygonEnd:a},Ae=function(t){return Fe.reset(),ne(t,Ie),+Fe},je=[null,null],Te={type:"LineString",coordinates:je},Ve=function(t,n){return je[0]=t,je[1]=n,Ae(Te)},Re=function(t,n){var e=t[0]*Gn,r=t[1]*Gn,o=n[0]*Gn,a=n[1]*Gn,l=Dn(r),s=$n(r),c=Dn(a),f=$n(a),p=l*Dn(e),y=l*$n(e),h=c*Dn(o),d=c*$n(o),m=2*i(Yn(u(a-r)+l*c*u(o-e))),g=$n(m),v=m?function(t){var n=$n(t*=m)/g,e=$n(m-t)/g,r=e*p+n*h,o=e*y+n*d,i=e*s+n*f
return[Hn(o,r)*Rn,Hn(i,Yn(r*r+o*o))*Rn]}:function(){return[e*Rn,r*Rn]}
return v.distance=m,v},Ge=function(t){return t},ze=Qt(),qe=Qt(),He={point:a,lineStart:a,lineEnd:a,polygonStart:function(){He.lineStart=ut,He.lineEnd=st},polygonEnd:function(){He.lineStart=He.lineEnd=He.point=a,ze.add(zn(qe)),qe.reset()},result:function(){var t=ze/2
return ze.reset(),t}},De=1/0,Je=De,Ue=-De,Ke=Ue,We={point:ct,lineStart:a,lineEnd:a,polygonStart:a,polygonEnd:a,result:function(){var t=[[De,Je],[Ue,Ke]]
...
return e.area=function(t){return ne(t,r(He)),He.result()},e.bounds=function(t){return ne(t,r(We)),We.result()},e.centroid=function(t){return ne(t,r(or)),or.result()},e.projection=function(n){return arguments.length?(r=null==(t=n)?Ge:n.stream,e):t},e.context=function(t){return arguments.length?(o=null==(n=t)?new xt:new Et(t),"function"!=typeof i&&o.pointRadius(i),e):n},e.pointRadius=function(t){return arguments.length?(i="function"==typeof t?t:(o.pointRadius(+t),+t),e):i},e.projection(t).context(n)},ur=Qt(),ar=function(t,n){var e=n[0],r=n[1],o=[$n(e),-Dn(e),0],u=0,a=0
ur.reset()
for(var l=0,s=t.length;s>l;++l)if(f=(c=t[l]).length)for(var c,f,p=c[f-1],y=p[0],h=p[1]/2+Tn,d=$n(h),g=Dn(h),b=0;f>b;++b,y=S,d=M,g=P,p=E){var E=c[b],S=E[0],w=E[1]/2+Tn,M=$n(w),P=Dn(w),L=S-y,N=L>=0?1:-1,B=N*L,k=B>An,_=d*M
if(ur.add(Hn(_*N*$n(B),g*P+_*Dn(B))),u+=k?L+N*Vn:L,k^y>=e^S>=e){var C=v(m(p),m(E))
x(C)
var O=v(o,C)
x(O)
var F=(k^L>=0?-1:1)*i(O[2]);(r>F||r===F&&(C[0]||C[1]))&&(a+=k^L>=0?1:-1)}}return(-Fn>u||Fn>u&&-Fn>ur)^1&a},lr=function(t,e,r,o){return function(i,u){function a(n,e){var r=i(n,e)
...
if(!n&&(a=o=d)&&t.lineStart(),d!==o&&(y=i(n,h),(Be(n,y)||Be(h,y))&&(h[0]+=Fn,h[1]+=Fn,d=r(h[0],h[1]))),d!==o)c=0,d?(t.lineStart(),y=i(h,n),t.point(y[0],y[1])):(y=i(n,h),t.point(y[0],y[1]),t.lineEnd()),n=y
...
k>_&&(B=k,k=_,_=B)
var F=_-k,I=zn(F-An)<Fn,A=I||Fn>F
if(!I&&C>O&&(B=C,C=O,O=B),A?I?C+O>0^N[1]<(zn(N[0]-k)<Fn?C:O):C<=N[1]&&N[1]<=O:F>An^(k<=N[0]&&N[0]<=_)){var j=E(S,(-w+L)/M)
return b(j,h),[N,d(j)]}}}function u(n,e){var r=l?t:An-t,o=0
return-r>n?o|=1:n>r&&(o|=2),-r>e?o|=4:e>r&&(o|=8),o}var a=Dn(t),l=a>0,s=zn(a)>Fn
...
var pr=16,yr=Dn(30*Gn),hr=function(t,n){return+n?Ft(t,n):Ot(t)},dr=Bt({point:function(t,n){this.stream.point(t*Gn,n*Gn)}}),mr=function(){return jt(Vt).scale(155.424).center([0,33.6442])},gr=function(){return mr().parallels([29.5,45.5]).scale(1070).translate([480,250]).rotate([96,0]).center([-.6,38.7])},vr=function(){function t(t){var n=t[0],e=t[1]
...
return(o>=.12&&.234>o&&r>=-.425&&-.214>r?s:o>=.166&&.234>o&&r>=-.214&&-.115>r?c:l).invert(t)},t.stream=function(t){return e&&r===t?e:e=Rt([l.stream(r=t),s.stream(t),c.stream(t)])},t.precision=function(t){return arguments.length?(l.precision(t),s.precision(t),c.precision(t),n()):l.precision()},t.scale=function(n){return arguments.length?(l.scale(n),s.scale(.35*n),c.scale(n),t.translate(l.translate())):l.scale()},t.translate=function(t){if(!arguments.length)return l.translate()
var e=l.scale(),r=+t[0],a=+t[1]
return o=l.translate(t).clipExtent([[r-.455*e,a-.238*e],[r+.455*e,a+.238*e]]).stream(f),i=s.translate([r-.307*e,a+.201*e]).clipExtent([[r-.425*e+Fn,a+.12*e+Fn],[r-.214*e-Fn,a+.234*e-Fn]]).stream(f),u=c.translate([r-.205*e,a+.212*e]).clipExtent([[r-.214*e+Fn,a+.166*e+Fn],[r-.115*e-Fn,a+.234*e-Fn]]).stream(f),n()},t.fitExtent=function(n,e){return _t(t,n,e)},t.fitSize=function(n,e){return Ct(t,n,e)},t.scale(1070)},br=Gt(function(t){return Yn(2/(1+t))})
br.invert=zt(function(t){return 2*i(t/2)})
var Er=function(){return It(br).scale(124.75).clipAngle(179.999)},xr=Gt(function(t){return(t=o(t))&&t/$n(t)})
xr.invert=zt(function(t){return t})
var Sr=function(){return It(xr).scale(79.4188).clipAngle(179.999)}
qt.invert=function(t,n){return[t,2*qn(Un(n))-jn]}
var wr=function(){return Ht(qt).scale(961/Vn)},Mr=function(){return jt(Jt).scale(109.5).parallels([30,30])}
Ut.invert=Ut
var Pr=function(){return It(Ut).scale(152.63)},Lr=function(){return jt(Kt).scale(131.154).center([0,13.9389])}
Wt.invert=zt(qn)
var Nr=function(){return It(Wt).scale(144.049).clipAngle(60)},Br=function(){function t(){return o=i=null,u}var n,e,r,o,i,u,a=1,l=0,s=0,c=Ge,f=null,p=Ge
return u={stream:function(t){return o&&i===t?o:o=c(p(i=t))},clipExtent:function(o){return arguments.length?(p=null==o?(f=n=e=r=null,Ge):Y(f=+o[0][0],n=+o[0][1],e=+o[1][0],r=+o[1][1]),t()):null==f?null:[[f,n],[e,r]]},scale:function(n){return arguments.length?(c=$t(a=+n,l,s),t()):a},translate:function(n){return arguments.length?(c=$t(a,l=+n[0],s=+n[1]),t()):[l,s]},fitExtent:function(t,n){return _t(u,t,n)},fitSize:function(t,n){return Ct(u,t,n)}}}
Xt.invert=zt(i)
var kr=function(){return It(Xt).scale(249.5).clipAngle(90+Fn)}
Yt.invert=zt(function(t){return 2*qn(t)})
var _r=function(){return It(Yt).scale(250).clipAngle(142)}
Zt.invert=function(t,n){return[-n,2*qn(Un(t))-jn]}
...
t.geoArea=ie,t.geoBounds=le,t.geoCentroid=ce,t.geoCircle=Pe,t.geoClipExtent=Oe,t.geoDistance=Ve,t.geoGraticule=ot,t.geoGraticule10=it,t.geoInterpolate=Re,t.geoLength=Ae,t.geoPath=ir,t.geoAlbers=gr,t.geoAlbersUsa=vr,t.geoAzimuthalEqualArea=Er,t.geoAzimuthalEqualAreaRaw=br,t.geoAzimuthalEquidistant=Sr,t.geoAzimuthalEquidistantRaw=xr,t.geoConicConformal=Mr,t.geoConicConformalRaw=Jt,t.geoConicEqualArea=mr,t.geoConicEqualAreaRaw=Vt,t.geoConicEquidistant=Lr,t.geoConicEquidistantRaw=Kt,t.geoEquirectangular=Pr,t.geoEquirectangularRaw=Ut,t.geoGnomonic=Nr,t.geoGnomonicRaw=Wt,t.geoIdentity=Br,t.geoProjection=It,t.geoProjectionMutator=At,t.geoMercator=wr,t.geoMercatorRaw=qt,t.geoOrthographic=kr,t.geoOrthographicRaw=Xt,t.geoStereographic=_r,t.geoStereographicRaw=Yt,t.geoTransverseMercator=Cr,t.geoTransverseMercatorRaw=Zt,t.geoRotation=Me,t.geoStream=ne,t.geoTransform=fr,Object.defineProperty(t,"__esModule",{value:!0})})},{"d3-array":43}],45:[function(t,n,e){function r(t,n,e,i){if(t===n.length)i(e)
else{var u=n[t]
