...
console.log(a),window.onload=function(){i()}},{"../../components/convert-svg-to-png":3,"../../components/drop-zone-svg":5}],3:[function(t,e,n){function i(t,e){t.toBlob(function(t){s.blob(e.name+".png",t)})}var r=t("./lib/html"),a=t("canvg-browser"),s=t("../utils/save")
